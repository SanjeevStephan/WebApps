			  ...
			  function loadAudio()
			  {
						...
						ebook_text += "<div class='row'>";
						 for(i = 0; i < ebook_titles.length ; i++)
						 {
								 ...
								 ebook_text +="<a href='' onclick=\"openInNewTab(' " + pdf_path + book_link[i] +".pdf');\">";
								 ebook_text +="<center>"
							...
							//	  ebook_text +="<br/><center><button onclick=\"openInNewTab(' " + pdf_path + book_link[i] +".pdf');\" class='btn btn-primary btn-sm'>Read Now</button></center>";
								  ebook_text +="<br/></span>";
								 ebook_text +="</div>";
